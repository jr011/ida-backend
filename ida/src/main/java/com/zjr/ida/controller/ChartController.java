package com.zjr.ida.controller;

import cn.hutool.core.io.FileUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.zjr.ida.annotation.AuthCheck;
import com.zjr.ida.bizmq.BiMessageProducer;
import com.zjr.ida.common.BaseResponse;
import com.zjr.ida.common.DeleteRequest;
import com.zjr.ida.common.ErrorCode;
import com.zjr.ida.common.ResultUtils;
import com.zjr.ida.constant.CommonConstant;
import com.zjr.ida.constant.UserConstant;
...
import com.zjr.ida.manager.RedisLimiterManager;
import com.zjr.ida.model.dto.chart.*;
import com.zjr.ida.model.entity.Chart;
import com.zjr.ida.model.entity.User;
import com.zjr.ida.model.enums.ResultEnum;
import com.zjr.ida.service.ChartService;
import com.zjr.ida.service.UserService;
import com.zjr.ida.utils.ChartDataUtil;
import com.zjr.ida.utils.ExcelUtils;
import com.zjr.ida.utils.InvalidEchartsUtil;
import com.zjr.ida.utils.SqlUtils;
...
public class ChartController {
    private static final String CHARTKEY = "chart_";
    ...
    public BaseResponse<Chart> getChartById(long id, HttpServletRequest request) {
        ...
        Chart chart = JSONUtil.toBean(stringRedisTemplate.opsForValue().get(key), Chart.class);
        if(chart.getId() != null) {
        ...
        stringRedisTemplate.opsForValue().set(key, JSONUtil.toJsonStr(chart));
        return ResultUtils.success(chart);
    }
...
//                "{明确的数据分析结论、越详细越好，不要生成多余的注释}";
    ...
    public BaseResponse<BiResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        CompletableFuture.runAsync(()->{
            ...
            //调用ai
            String result=aiManager.sentMesToAIUseZhiPu(userInput.toString());
